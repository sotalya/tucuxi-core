...
// clang-format off
static const std::string xmlInputTests[7] = {
    // TEST1
    "<root>"
        "<treatment>"
            "<dosageHistory>"
    ...
    // Test SingleDoseAtTimeList (one dose only).
    "<root>"
        "<treatment>"
            "<dosageHistory>"
                "<dosageTimeRange>"
                    "<start>2021-09-12T00:36:30</start>"
                    "<end>2021-09-30T12:36:30</end>"
                    "<dosage>"
    ...
    // Test SingleDoseAtTimeList (multiple doses).
    "<root>"
        "<treatment>"
            "<dosageHistory>"
                "<dosageTimeRange>"
                    ...
                    "<dosage>"
                        "<singleDoseAtTimeList>"
                            ...
                            "</singleDoseAtTime>"
                            "<singleDoseAtTime>"
                                "<doseDate>2021-09-14T10:36:30</doseDate>"
                                "<dose>"
                                    "<infusionTimeInMinutes>40.000000</infusionTimeInMinutes>"
                                    "<value>30.000000</value>"
                                    "<unit>mg</unit>"
                                "</dose>"
                                "<formulationAndRoute>"
                                    "<formulation>oralSolution</formulation>"
                                    "<administrationName>A third oral tablet</administrationName>"
                                    "<administrationRoute>oral</administrationRoute>"
                                "</formulationAndRoute>"
                            "</singleDoseAtTime>"
                        "</singleDoseAtTimeList>"
    ...
    // Test simpleDoseList (multiple doses, with simple format).
    "<root>"
        "<treatment>"
            "<dosageHistory>"
                "<dosageTimeRange>"
                        ...
                        "<simpleDoseList>"
                            ...
                            "<doseList>"
                                ...
                                "<doseDateValue>"
                                    ...
                                    "<infusionTimeInMinutes>70.000000</infusionTimeInMinutes>"
                                    "<value>20.000000</value>"
                                "</doseDateValue>"
                                "<doseDateValue>"
                                    "<doseDate>2021-09-12T02:36:30</doseDate>"
                                    "<infusionTimeInMinutes>80.000000</infusionTimeInMinutes>"
                                    "<value>30.000000</value>"
                                "</doseDateValue>"
                                "<doseDateValue>"
                                    "<doseDate>2021-09-14T00:36:30</doseDate>"
                                    "<infusionTimeInMinutes>90.000000</infusionTimeInMinutes>"
