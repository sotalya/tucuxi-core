...
struct TestOperation : public fructose::test_base<TestOperation>
{
    ...
    void testHardcodedOperation(const std::string& /* _testName */)
    {
        ...
        fructose_assert(
                diff.check({OperationInput("b", 1), OperationInput("a", 1.234), OperationInput("c", 1.234)}) == true);
        fructose_assert(
                diff.check({OperationInput("b", 1), OperationInput("a", 1.234), OperationInput("a", 1.234)}) == false);
        fructose_assert(
                diff.check({OperationInput("b", 1), OperationInput("a", 1.234), OperationInput("a", 2.34)}) == false);
