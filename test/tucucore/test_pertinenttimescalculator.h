...
struct TestPertinentTimesCalculator : public fructose::test_base<TestPertinentTimesCalculator>
{
    ...
    {
        {
            ...
            IntakeEvent intake(DateTime(), Duration(), 0.0, Tucuxi::Common::Unit("mg"), interval, Tucuxi::Core::FormulationAndRoute(AbsorptionModel::Extravascular), AbsorptionModel::Extravascular, infusionTime, nbPoints);
    ...
    void testInfusion(const std::string& /* _testName */)
    {
...

        {
            ...
            IntakeEvent intake(DateTime(), Duration(), 0.0, Tucuxi::Common::Unit("mg"), interval, Tucuxi::Core::FormulationAndRoute(AbsorptionModel::Infusion), AbsorptionModel::Infusion, infusionTime, nbPoints);
            calculator.calculateTimes(intake, nbPoints, times);
