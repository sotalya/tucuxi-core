...
TEST(Core_TestPkModel, PkModelFunctions)
{
    ...
    ASSERT_NE(std::find(l1MicroROA.begin(), l1MicroROA.end(), AbsorptionModel::Extravascular), l1MicroROA.end());
    ASSERT_NE(std::find(l1MacroROA.begin(), l1MacroROA.end(), AbsorptionModel::Extravascular), l1MacroROA.end());
    ASSERT_NE(std::find(l1MicroROA.begin(), l1MicroROA.end(), AbsorptionModel::Intravascular), l1MicroROA.end());
    ASSERT_NE(std::find(l1MacroROA.begin(), l1MacroROA.end(), AbsorptionModel::Intravascular), l1MacroROA.end());
