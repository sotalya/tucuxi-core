...
#ifndef TEST_COMPUTINGCOMPONENTATTIMES_H
#define TEST_COMPUTINGCOMPONENTATTIMES_H
...
struct TestComputingComponentAtTimes : public fructose::test_base<TestComputingComponentAtTimes>
{
    TestComputingComponentAtTimes() {}

    std::unique_ptr<DrugModel> buildDrugModel()
    {
        const std::string test_mm_1comp_extra_tdd = R"(<?xml version="1.0" encoding="UTF-8"?>
<model version='0.6' xsi:noNamespaceSchemaLocation='drugfile.xsd' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance'>
    ...
    void testMeasureFar(const std::string& /* _testName */)
    {
...

        {
            ...
            fructose_assert_eq(result2, ComputingStatus::Ok);
            ...
            fructose_assert(dynamic_cast<const SinglePointsData*>(responseData2) != nullptr);
            ...
            fructose_assert_double_eq(data[0].getConcentrations()[0][12], data2[0][0]);
            fructose_assert_double_eq(data[0].getConcentrations()[0][24], data2[0][1]);
        }
    ...
    void testMeasureFarTimes(const std::string& /* _testName */)
    {
        IComputingService* component = dynamic_cast<IComputingService*>(ComputingComponent::createComponent());
...

        {
            ...
            auto data = resp->getData();
            auto data2 = resp2->m_concentrations;
            fructose_assert_double_eq(data[29].getConcentrations()[0][12], data2[0][1]);
            fructose_assert_double_eq(data[29].getConcentrations()[0][24], data2[0][2]);
        }
        ...
        /*
        {
            ...
            auto data = resp->getData();
            auto data2 = resp2->m_concentrations;
            fructose_assert_double_eq(data[29].getConcentrations()[0][12], data2[0][0]);
            fructose_assert_double_eq(data[29].getConcentrations()[0][24], data2[0][1]);
...
#endif // TEST_COMPUTINGCOMPONENTATTIMES_H
