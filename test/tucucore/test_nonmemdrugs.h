...
struct TestNonMemDrugs : public fructose::test_base<TestNonMemDrugs>
{
                        ...
                        int _nbPoints)
    {
        ...
        // with ConcentrationCalculator vs directly with the IntakeIntervalCalculator
        {
            ...
            Tucuxi::Core::IntakeEvent intakeEvent(now, offsetTime, _dose, Tucuxi::Common::Unit("mg"), interval, _formulationAndRoute, _route, infusionTime, _nbPoints);
