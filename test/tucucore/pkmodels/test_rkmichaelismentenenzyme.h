#ifndef TEST_RKMICHAELISMENTENENZYME_H
#define TEST_RKMICHAELISMENTENENZYME_H
...
static std::string test_mm_1comp_enzyme_bolus_tdd = R"(<?xml version="1.0" encoding="UTF-8"?>
...
struct TestMichaelisMentenEnzyme1comp : public fructose::test_base<TestMichaelisMentenEnzyme1comp>
{
    TestMichaelisMentenEnzyme1comp() { }
    ...
    void buildDrugTreatment(DrugTreatment *&_drugTreatment, FormulationAndRoute _route)
    {
        ...
        LastingDose periodicDose(DoseValue(500.0),
                                 TucuUnit("mg"),
                                 _route,
                                 Duration(),
    ...
    void testBolus(const std::string& /* _testName */)
    {
        ...
        importer.importFromString(drugModel, test_mm_1comp_enzyme_bolus_tdd);
...

        {
            ...
            fructose_assert(dynamic_cast<const SinglePredictionData*>(responseData) != nullptr);if (dynamic_cast<const SinglePredictionData*>(responseData) == nullptr) {
                return;
            }
...
#endif // TEST_RKMICHAELISMENTENENZYME_H
