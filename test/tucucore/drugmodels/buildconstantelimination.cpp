...
std::unique_ptr<Tucuxi::Core::DrugModel> BuildConstantElimination::buildDrugModel(
        ResidualErrorType _errorModelType,
        std::vector<Value> _sigmas,
        Tucuxi::Core::ParameterVariabilityType _variabilityTypeA,
        Tucuxi::Core::ParameterVariabilityType _variabilityTypeM,
        Tucuxi::Core::ParameterVariabilityType _variabilityTypeR,
        Tucuxi::Core::ParameterVariabilityType _variabilityTypeS,
        Value _variabilityValueA,
        Value _variabilityValueM,
        Value _variabilityValueR,
        Value _variabilityValueS)
{
    ...
    std::unique_ptr<ActiveMoiety> activeMoiety = std::make_unique<ActiveMoiety>(
            ActiveMoietyId("activeMoietyConstant"), TucuUnit("ug/l"), analyteList, std::move(activeMoietyOperation));
