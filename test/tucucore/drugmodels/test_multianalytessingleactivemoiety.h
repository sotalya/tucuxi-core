...
#ifndef TEST_MULTIANALYTESSINGLEACTIVEMOIETY_H
#define TEST_MULTIANALYTESSINGLEACTIVEMOIETY_H
...
struct TestMultiAnalytesSingleActiveMoiety : public fructose::test_base<TestMultiAnalytesSingleActiveMoiety>
{
    ...
    std::unique_ptr<DrugTreatment> buildDrugTreatment(FormulationAndRoute _route)
    {
        ...
        std::unique_ptr<Tucuxi::Core::DosageTimeRange> sept2018 =
                std::make_unique<Tucuxi::Core::DosageTimeRange>(startSept2018, repeatedDose);
...
#endif // TEST_MULTIANALYTESSINGLEACTIVEMOIETY_H
