...
public:
            ...
            Value _variabilityValueS = 0.0)
    {
        ...
        auto opS = std::make_unique<JSOperation>(
                "return covS;",
                OperationInputList{OperationInput("covS", InputType::DOUBLE)});
        ...
        auto opA = std::make_unique<JSOperation>(
                "return covA;",
                OperationInputList{OperationInput("covA", InputType::DOUBLE)});
        ...
        auto opM = std::make_unique<JSOperation>(
                "return covM;",
                OperationInputList{OperationInput("covM", InputType::DOUBLE)});
