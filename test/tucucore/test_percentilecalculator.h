...
struct TestPercentileCalculator : public fructose::test_base<TestPercentileCalculator>
{
    ...
    void testApriori(const std::string& /* _testName */)
    {
        ...
        Tucuxi::Core::IntakeEvent intakeEvent(now, offsetTime, dose, Tucuxi::Common::Unit("mg"), interval, Tucuxi::Core::FormulationAndRoute(route), route, infusionTime, CYCLE_SIZE);
        ...
        Tucuxi::Core::IntakeEvent intakeEvent2(now + 24h, offsetTime, dose,Tucuxi::Common::Unit("mg"), interval, Tucuxi::Core::FormulationAndRoute(route), route, infusionTime, CYCLE_SIZE);
        intakeEvent2.setCalculator(calculator2);
        intakeSeries.push_back(intakeEvent2);

        Tucuxi::Core::IntakeEvent intakeEvent3(now + 48h, offsetTime, dose,Tucuxi::Common::Unit("mg"), interval, Tucuxi::Core::FormulationAndRoute(route), route, infusionTime, CYCLE_SIZE);
        intakeEvent3.setCalculator(calculator2);
        intakeSeries.push_back(intakeEvent3);

        Tucuxi::Core::IntakeEvent intakeEvent4(now + 72h, offsetTime, dose,Tucuxi::Common::Unit("mg"), interval, Tucuxi::Core::FormulationAndRoute(route), route, infusionTime, CYCLE_SIZE);
