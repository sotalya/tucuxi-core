...
private:
    ...
    std::unique_ptr<DrugModelDomain> howManyConstraints(
    ...
    DrugTreatment howManyPatientCovariate(
    ...
    std::vector<DrugDomainConstraintsEvaluator::EvaluationResult> evaluateUniqueResult(
