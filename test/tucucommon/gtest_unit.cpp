...
static void testTemperature(vector<string>& _temperatureUnits)
{
...
static void testNoUnit(vector<string>& _noUnits)
{
    Tucuxi::Common::UnitManager unitManager;
...
static void testWeight(vector<string>& _weightUnits)
{
...
static void testHeight(vector<string>& _lengthUnits)
{
...
static void testTime(vector<string>& _timeUnits)
{
...
static void testConcentration(vector<string>& _concentrationUnits)
{
...
static void testConcentrationTime(vector<string>& _concentrationTimeUnits)
{
...
static void testConcentrationMole(vector<string>& _concentrationMoleUnits)
{
...
static void testMolarMass(vector<string> _molarMass)
{
    Tucuxi::Common::UnitManager unitManager;
...
static void testFlowRate(vector<string>& _flowRate)
{
