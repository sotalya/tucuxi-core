...
TEST(Common_TestUnit, TemperatureUnit)
{
    ...
    ASSERT_DOUBLE_EQ(
            unitManager.convertToUnit(value, Tucuxi::Common::TucuUnit("celsius"), Tucuxi::Common::TucuUnit("celsius")),
            1.0);
}
...
TEST(Common_TestUnit, NoUnit)
{
    ...
    ASSERT_DOUBLE_EQ(unitManager.convertToUnit(value, Tucuxi::Common::TucuUnit(""), Tucuxi::Common::TucuUnit("")), 1.0);
    ASSERT_DOUBLE_EQ(
