...
class RkMichaelisMentenLinearTwoCompVmaxAmount : public IntakeIntervalCalculatorRK4Base<3, RkMichaelisMentenLinearTwoCompVmaxAmount>
{
...
/// \brief Intake interval calculator for the one compartment extravascular algorithm
/// \sa IntakeIntervalCalculator
class RkMichaelisMentenLinearTwoCompVmaxAmountExtraLagMacro : public RkMichaelisMentenLinearTwoCompVmaxAmountExtraLagMicro
{
...
/// \brief Intake interval calculator for the one compartment extravascular algorithm
/// \sa IntakeIntervalCalculator
class RkMichaelisMentenLinearTwoCompVmaxAmountInfusionMacro : public RkMichaelisMentenLinearTwoCompVmaxAmountInfusionMicro
{
