...
RK4OneCompartmentGammaExtraMicro::RK4OneCompartmentGammaExtraMicro() : IntakeIntervalCalculatorRK4Base<2, RK4OneCompartmentGammaExtraMicro> (new PertinentTimesCalculatorStandard())
{
}
