...
RkMichaelisMentenLinearTwoCompVmaxAmount::RkMichaelisMentenLinearTwoCompVmaxAmount()
    : IntakeIntervalCalculatorRK4Base<3, RkMichaelisMentenLinearTwoCompVmaxAmount>(std::make_unique<PertinentTimesCalculatorStandard>())
{
    m_Tinf = 0.0;
    m_Tlag = 0.0;
}
...
RkMichaelisMentenLinearTwoCompVmaxAmountExtraMicro::RkMichaelisMentenLinearTwoCompVmaxAmountExtraMicro() : RkMichaelisMentenLinearTwoCompVmaxAmount()
{
    m_delivered = true;
    m_isInfusion = false;
    m_isWithLag = false;
...
RkMichaelisMentenLinearTwoCompVmaxAmountExtraLagMicro::RkMichaelisMentenLinearTwoCompVmaxAmountExtraLagMicro() : RkMichaelisMentenLinearTwoCompVmaxAmount()
{
    m_delivered = false;
    m_isInfusion = false;
    m_isWithLag = true;
...
RkMichaelisMentenLinearTwoCompVmaxAmountBolusMicro::RkMichaelisMentenLinearTwoCompVmaxAmountBolusMicro() : RkMichaelisMentenLinearTwoCompVmaxAmount()
{
    m_delivered = true;
    m_isInfusion = false;
    m_isWithLag = false;
...
RkMichaelisMentenLinearTwoCompVmaxAmountInfusionMicro::RkMichaelisMentenLinearTwoCompVmaxAmountInfusionMicro() : RkMichaelisMentenLinearTwoCompVmaxAmount()
{
    m_delivered = true;
    m_isInfusion = true;
    m_isWithLag = false;
...
RkMichaelisMentenLinearTwoCompVmaxAmountExtraLagMacro::RkMichaelisMentenLinearTwoCompVmaxAmountExtraLagMacro() = default;
...
RkMichaelisMentenLinearTwoCompVmaxAmountInfusionMacro::RkMichaelisMentenLinearTwoCompVmaxAmountInfusionMacro() = default;
