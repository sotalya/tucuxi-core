...
public:
    ...
    {
        return {_residuals[0] / m_V1, _residuals[1] / m_V2, _residuals[2] / m_V3, _residuals[3] / m_V1};
    }
...
protected:
            ...
            Residuals& _outResiduals, MultiCompConcentrations& _concentrations, size_t _index) override
    {
        ...
        _outResiduals[2] = _concentrations[2][_index] * m_V3;
        _outResiduals[3] = _concentrations[3][_index] * m_V1;
    }
    ...
    Value m_V3{NAN}; /// Volume of the third compartment
    Value m_Ke{NAN};
    Value m_K12{NAN};
    Value m_K21{NAN};
    Value m_K13{NAN};
...
protected:
    ...
    void initConcentrations(const Residuals& _inResiduals, MultiCompConcentration& _concentrations) override
    {
        ...
        _concentrations[2] = _inResiduals[2] / m_V3;
        _concentrations[3] = (_inResiduals[3] + m_D * m_F) / m_V1;
    }
};
...
protected:
    ...
    void initConcentrations(const Residuals& _inResiduals, MultiCompConcentration& _concentrations) override
    {
        ...
        _concentrations[1] = _inResiduals[1] / m_V2;
        _concentrations[2] = _inResiduals[2] / m_V3;
        _concentrations[3] = _inResiduals[3] / m_V1;
