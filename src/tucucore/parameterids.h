...
public:
    ...
    enum Enum { V, V1, V2, CL, Ka, Ke, K12, K21, K13, K31, F, Q, Q1, Q2, Ktr, Tlag, Km,
                Vmax, TestA, TestM, TestR, TestS,TestA0, TestM0, TestR0, TestS0, TestA1, TestM1, TestR1, TestS1, TestT, a, b, Kenz, Emax, ECmid, EDmid,
    ...
    static Enum fromString(const std::string &_id) {
        static const std::map<std::string, Enum> sm_paramIds = {  // NOLINT(readability-identifier-naming)
            ...
            { "Q2",  ParameterId::Q2 },
            { "Ktr",  ParameterId::Ktr },
            { "Tlag", ParameterId::Tlag },
            { "Km", ParameterId::Km },
            { "Vmax", ParameterId::Vmax },
            { "TestA",  ParameterId::TestA },
            { "TestM",  ParameterId::TestM },
            { "TestR",  ParameterId::TestR },
            { "TestS",  ParameterId::TestS },
            { "TestA0",  ParameterId::TestA0 },
            { "TestM0",  ParameterId::TestM0 },
            { "TestR0",  ParameterId::TestR0 },
            { "TestS0",  ParameterId::TestS0 },
            { "TestA1",  ParameterId::TestA1 },
            { "TestM1",  ParameterId::TestM1 },
            { "TestR1",  ParameterId::TestR1 },
            { "TestS1",  ParameterId::TestS1 },
