#ifndef TUCUXI_CORE_MULTICOMPUTINGCOMPONENT_H
#define TUCUXI_CORE_MULTICOMPUTINGCOMPONENT_H
...
public:
    ...
    /// \brief Destructor
    ~MultiComputingComponent() override;
...
#endif // TUCUXI_CORE_MULTICOMPUTINGCOMPONENT_H
