...
public:
    ...
    bool get(const Tucuxi::Common::Duration& _cycleDuration, const Parameters& _parameters, CycleSize _nbPoints, PrecomputedLogarithms& _logarithms);
    ...
    void set(const Tucuxi::Common::Duration& _cycleDuration, const Parameters& _parameters, CycleSize _nbPoints, const PrecomputedLogarithms& _logarithms);
...
private:
    ...
    std::size_t hash(const Tucuxi::Common::Duration& _cycleDuration, const Parameters& _parameters, CycleSize _nbPoints) const;
