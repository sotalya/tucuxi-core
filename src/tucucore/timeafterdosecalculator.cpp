        ...
        const Samples& _samples, const DosageHistory& _dosageHistory) const
{
    ...
    for (auto const& tr : trs) {
        ...
        {
            SimpleDoseList const* const dosagePtr = dynamic_cast<SimpleDoseList const* const>(dosage);
            if (dosagePtr != nullptr) {
        ...
        {
            SingleDoseAtTimeList const* const dosagePtr = dynamic_cast<SingleDoseAtTimeList const* const>(dosage);
            if (dosagePtr != nullptr) {
