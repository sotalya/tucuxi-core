...
std::vector<TimeOffsets> &_times)
{
	...
	m_stats[compartment][static_cast<int>(CycleStatisticType::Mean)].addValue(Duration(), (auc/(_times[compartment][_concentrations[compartment].size() - 1] - _times[compartment][0])));
