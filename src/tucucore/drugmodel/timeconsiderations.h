...
{
public:
    HalfLife(const std::string& _id, Value _value, TucuUnit _unit, double _multiplier, std::unique_ptr<Operation> _operation = nullptr)
...
public:
    ...
    OutdatedMeasure(const std::string& _id, const Value _value, TucuUnit _unit, std::unique_ptr<Operation> _operation = nullptr)
