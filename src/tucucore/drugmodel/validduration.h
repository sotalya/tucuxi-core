...
public:
    ...
    INVARIANTS(
            INVARIANT(Invariants::INV_VALIDDURATIONS_0001, (Common::UnitManager::isOfType<Common::UnitManager::UnitType::Time>(m_unit)), "A duration does not have a corresponding unit")
