...
TargetDefinition* DrugModelImport::extractTarget(Tucuxi::Common::XmlNodeIterator _node)
{
    ...
    target = new TargetDefinition(type, unit, ActiveMoietyId(""),
                                  ...
                                  std::make_unique<SubTargetDefinition>("tMin", UnitManager::convertToUnit<UnitManager::UnitType::Time>(tMin->getValue(), tUnit, Unit("m")), tMin->getOperation()),
                                  std::make_unique<SubTargetDefinition>("tMax", UnitManager::convertToUnit<UnitManager::UnitType::Time>(tMax->getValue(), tUnit, Unit("m")), tMax->getOperation()),
                                  std::make_unique<SubTargetDefinition>("tBest", UnitManager::convertToUnit<UnitManager::UnitType::Time>(tBest->getValue(), tUnit, Unit("m")), tBest->getOperation()),
