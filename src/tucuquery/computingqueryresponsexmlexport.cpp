...
bool ComputingQueryResponseXmlExport::exportToString(
        const ComputingQueryResponse& _computingQueryResponse, std::string& _xmlString)
{
    ...
    Tucuxi::Common::XmlNode queryId =
            m_doc.createNode(Tucuxi::Common::EXmlNodeType::Element, "queryId", _computingQueryResponse.getQueryId());
    root.addChild(queryId);

    Tucuxi::Common::XmlNode queryStatus =
            m_doc.createNode(Tucuxi::Common::EXmlNodeType::Element, "queryStatus", "queryStatus");
    root.addChild(queryStatus);

    Tucuxi::Common::XmlNode statusCode = m_doc.createNode(
            Tucuxi::Common::EXmlNodeType::Element,
            "statusCode",
            getQueryStatus(_computingQueryResponse.getQueryStatus(), STATUS_CODE_NUMBER));
    queryStatus.addChild(statusCode);

    Tucuxi::Common::XmlNode statusCodeLit = m_doc.createNode(
            Tucuxi::Common::EXmlNodeType::Element,
            "statusCodeLit",
            getQueryStatus(_computingQueryResponse.getQueryStatus(), STATUS_CODE_MESSAGE));
    queryStatus.addChild(statusCodeLit);

    Tucuxi::Common::XmlNode message = m_doc.createNode(
            Tucuxi::Common::EXmlNodeType::Element, "message", _computingQueryResponse.getErrorMessage());
    ...
    for (const auto& response : _computingQueryResponse.getRequestResponses()) {
        ...
        Tucuxi::Common::XmlNode requestId = m_doc.createNode(
                Tucuxi::Common::EXmlNodeType::Element, "requestId", response.m_computingResponse->getId());
        responseNode.addChild(requestId);

        Tucuxi::Common::XmlNode requestStatus =
                m_doc.createNode(Tucuxi::Common::EXmlNodeType::Element, "requestStatus");
        responseNode.addChild(requestStatus);

        Tucuxi::Common::XmlNode statusCode = m_doc.createNode(
                Tucuxi::Common::EXmlNodeType::Element,
                "statusCode",
                getComputingStatus(response.m_computingResponse->getComputingStatus(), STATUS_CODE_NUMBER));
        requestStatus.addChild(statusCode);

        Tucuxi::Common::XmlNode statusCodeLit = m_doc.createNode(
                Tucuxi::Common::EXmlNodeType::Element,
                "statusCodeLit",
                getComputingStatus(response.m_computingResponse->getComputingStatus(), STATUS_CODE_MESSAGE));
        ...
        if (dynamic_cast<const Tucuxi::Core::AdjustmentData*>(response.m_computingResponse->getData()) != nullptr) {
            ...
            Tucuxi::Common::XmlNode dataNode =
            ...
            Tucuxi::Common::XmlNode dataNode =
                    m_doc.createNode(Tucuxi::Common::EXmlNodeType::Element, "dataPrediction");
            ...
            Tucuxi::Common::XmlNode dataNode =
                    m_doc.createNode(Tucuxi::Common::EXmlNodeType::Element, "dataPercentiles");
...
std::string ComputingQueryResponseXmlExport::getComputingStatus(
        Tucuxi::Core::ComputingStatus _computingStatus, bool _codeEnable) const
{
...
bool ComputingQueryResponseXmlExport::exportAdjustment(
        const Tucuxi::Core::AdjustmentData* _prediction, Tucuxi::Common::XmlNode& _rootNode)
{
    ...
    Tucuxi::Common::XmlNode adjustments = m_doc.createNode(Tucuxi::Common::EXmlNodeType::Element, "adjustments");
    _rootNode.addChild(adjustments);

    for (const auto& adj : _prediction->getAdjustments()) {
        Tucuxi::Common::XmlNode adjustment = m_doc.createNode(Tucuxi::Common::EXmlNodeType::Element, "adjustment");
        adjustments.addChild(adjustment);
        addNode(adjustment, "score", adj.getGlobalScore());
        Tucuxi::Common::XmlNode targetEvaluations =
        ...
        for (const auto& target : adj.m_targetsEvaluation) {
            Tucuxi::Common::XmlNode targetEvaluation =
        ...
        const Tucuxi::Core::SinglePointsData* _prediction, Tucuxi::Common::XmlNode& _rootNode)
{
    ...
    for (size_t i = 0; i < _prediction->m_times.size(); i++) {
        Tucuxi::Common::XmlNode point = m_doc.createNode(Tucuxi::Common::EXmlNodeType::Element, "point");
...
void ComputingQueryResponseXmlExport::addNode(
...
bool ComputingQueryResponseXmlExport::exportPercentiles(
        const Tucuxi::Core::PercentilesData* _prediction, Tucuxi::Common::XmlNode& _rootNode)
{
    size_t nbRanks = _prediction->getNbRanks();
    for (unsigned int index = 0; index < nbRanks; index++) {
        Tucuxi::Common::XmlNode percentile = m_doc.createNode(Tucuxi::Common::EXmlNodeType::Element, "percentile");
...
bool ComputingQueryResponseXmlExport::exportAbstractDosage(
...
bool ComputingQueryResponseXmlExport::exportDosage(
        const Tucuxi::Core::SingleDoseAtTimeList& _dosage, Tucuxi::Common::XmlNode& _rootNode)
{
    Tucuxi::Common::XmlNode singleDoseAtTimeList =
            m_doc.createNode(Tucuxi::Common::EXmlNodeType::Element, "singleDoseAtTimeList");
...
bool ComputingQueryResponseXmlExport::exportDosage(
        const Tucuxi::Core::SingleDoseAtTime& _dosage, Tucuxi::Common::XmlNode& _rootNode)
{
    Tucuxi::Common::XmlNode singleDoseAtTime =
            m_doc.createNode(Tucuxi::Common::EXmlNodeType::Element, "singleDoseAtTime");
    _rootNode.addChild(singleDoseAtTime);

    addNode(singleDoseAtTime, "doseDate", dateTimeToString(_dosage.getDateTime()));
    ...
    addNode(formulationAndRoute, "administrationName", _dosage.getFormulationAndRoute().getAdministrationName());
    addNode(formulationAndRoute,
            "administrationRoute",
...
bool ComputingQueryResponseXmlExport::exportDosage(
        const Tucuxi::Core::SimpleDoseList& _dosage, Tucuxi::Common::XmlNode& _rootNode)
{
    Tucuxi::Common::XmlNode simpleDoseList = m_doc.createNode(Tucuxi::Common::EXmlNodeType::Element, "simpleDoseList");
    ...
    Tucuxi::Common::XmlNode doseList = m_doc.createNode(Tucuxi::Common::EXmlNodeType::Element, "doseList");
...
bool ComputingQueryResponseXmlExport::exportDosage(
        const Tucuxi::Core::SimpleDose& _dosage, Tucuxi::Common::XmlNode& _rootNode)
{
    Tucuxi::Common::XmlNode doseDateValue = m_doc.createNode(Tucuxi::Common::EXmlNodeType::Element, "doseDateValue");
    _rootNode.addChild(doseDateValue);

    addNode(doseDateValue, "doseDate", dateTimeToString(_dosage.getDateTime()));
    addNode(doseDateValue, "infusionTimeInMinutes", _dosage.getInfusionTime().toMinutes());
...
bool ComputingQueryResponseXmlExport::exportDosage(
        const Tucuxi::Core::DailyDose& _dosage, Tucuxi::Common::XmlNode& _rootNode)
{
...
void ComputingQueryResponseXmlExport::exportSingleDose(
...
void ComputingQueryResponseXmlExport::exportDose(
        const Tucuxi::Core::SingleDose& _dosage, Tucuxi::Common::XmlNode& _rootNode)
{
    Tucuxi::Common::XmlNode dose = m_doc.createNode(Tucuxi::Common::EXmlNodeType::Element, "dose");
...
void ComputingQueryResponseXmlExport::exportFormulationAndRoute(
        const Tucuxi::Core::SingleDose& _dosage, Tucuxi::Common::XmlNode& _rootNode)
{
    Tucuxi::Common::XmlNode formulationAndRoute =
            m_doc.createNode(Tucuxi::Common::EXmlNodeType::Element, "formulationAndRoute");
    ...
    addNode(formulationAndRoute,
            "formulation",
            formulationEnumToString(_dosage.getLastFormulationAndRoute().getFormulation()));
...
std::string ComputingQueryResponseXmlExport::administrationRouteEnumToString(
        const Tucuxi::Core::AdministrationRoute& _administrationRoute)
{
...
std::string ComputingQueryResponseXmlExport::absorptionModelEnumToString(
        const Tucuxi::Core::AbsorptionModel& _absorptionModel)
{
...
bool ComputingQueryResponseXmlExport::exportCycleData(
        const Tucuxi::Core::CycleData& _cycleData, Tucuxi::Common::XmlNode& _rootNode)
{
    ...
    Tucuxi::Common::XmlNode parameters = m_doc.createNode(Tucuxi::Common::EXmlNodeType::Element, "parameters");
    cycleData.addChild(parameters);
    for (const auto& parameter : _cycleData.m_parameters) {
        Tucuxi::Common::XmlNode parameterNode = m_doc.createNode(Tucuxi::Common::EXmlNodeType::Element, "parameter");
    ...
    if (!_cycleData.m_statistics.getStats().empty()) {
        ...
        Tucuxi::Common::XmlNode statistics = m_doc.createNode(Tucuxi::Common::EXmlNodeType::Element, "statistics");
        ...
        ok &= _cycleData.m_statistics.getStatistic(0, Tucuxi::Core::CycleStatisticType::CumulativeAuc)
                      .getValue(date, cumulativeAuc);
        ok &= _cycleData.m_statistics.getStatistic(0, Tucuxi::Core::CycleStatisticType::Residual)
...
bool ComputingQueryResponseXmlExport::exportCycleDatas(
        const std::vector<Tucuxi::Core::CycleData>& _cycleDatas, Tucuxi::Common::XmlNode& _rootNode)
{
    Tucuxi::Common::XmlNode cycleDatas = m_doc.createNode(Tucuxi::Common::EXmlNodeType::Element, "cycleDatas");
...
bool ComputingQueryResponseXmlExport::exportDosageHistory(
        const DosageHistory& _history, Tucuxi::Common::XmlNode& _rootNode)
{
